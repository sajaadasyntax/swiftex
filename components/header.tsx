      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <Link href="#emergency" className="text-sm font-medium text-red-600 transition-colors hover:text-red-500">
              Emergency
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="border-t py-4 md:hidden">
            <nav className="flex flex-col gap-4">
              ...
              <Link href="#emergency" className="text-sm font-medium text-red-600 transition-colors hover:text-red-500" onClick={() => setMobileMenuOpen(false)}>
                Emergency
              </Link>
